...
public class Bus_Tickets_Pojo implements Serializable{
    ...
    public BoardingDetails_Pojo getBoardingDroppingDetails() { return this.BoardingDetails; }

    public void setBoardingDroppingDetails(BoardingDetails_Pojo BoardingDetails) { this.BoardingDetails = BoardingDetails; }
