...
public class ReturnFlightSegmentDTO implements Serializable{
    ...
    private InternationalreturnBookingClass_DTO BookingClass;

    public InternationalreturnBookingClass_DTO getBookingClass() { return this.BookingClass; }

    public void setBookingClass(InternationalreturnBookingClass_DTO BookingClass) { this.BookingClass = BookingClass; }

    private International_Return_Booking_Class_Fare BookingClassFare;

    public International_Return_Booking_Class_Fare getBookingClassFare() { return this.BookingClassFare; }

    public void setBookingClassFare(International_Return_Booking_Class_Fare BookingClassFare) { this.BookingClassFare = BookingClassFare; }
    ...
    private InternationalReturnBaggageAllowed_DTO BaggageAllowed;

    public InternationalReturnBaggageAllowed_DTO getBaggageAllowed() { return this.BaggageAllowed; }

    public void setBaggageAllowed(InternationalReturnBaggageAllowed_DTO BaggageAllowed) { this.BaggageAllowed = BaggageAllowed; }
