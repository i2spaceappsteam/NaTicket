...
public class Flights_Domestic_Onward extends BackActivity {
    ...
    private void callFlightsData() {
        ...
        if (Util.isNetworkAvailable(getApplicationContext())) {
            ...
            ServiceClasses.getAvaliableFlights(Flights_Domestic_Onward.this, url);
    ...
    private void setFlightsData(ArrayList<DomesticOnwardFlightDTO> availableFlights) {
        domesticOnward_adapter = new Domestic_Onward_Adapter(this, availableFlights);
    ...
    private void showAlertDialog(String s) {
        ...
        alertDialog.setTitle("No flights found!");
