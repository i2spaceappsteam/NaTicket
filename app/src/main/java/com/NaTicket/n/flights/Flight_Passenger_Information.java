...
public class Flight_Passenger_Information extends BackActivity implements View.OnClickListener {
    ...
    public void initviews(){
        ...
        Continue_to_Pay= (TextView) findViewById(R.id.proceedTopay);
    ...
    public void setPaxdata(){
       ...
       /* madapter   = new Passenger_Adapter(this,PassengersArrayList,selDetails,passenegrs);
        ...
        Mobile_et= (EditText) findViewById(R.id.phone);
        Email_et= (EditText) findViewById(R.id.email);
        City_et= (EditText) findViewById(R.id.city);
        State_et= (EditText) findViewById(R.id.state);
        Pincode_et= (EditText) findViewById(R.id.postalcode);
        ...
        FaresTv = (TextView) findViewById(R.id.fare_tv);
    ...
    private String preparePayload() {
        ...
        try {
            jsonBody.put("BookingResponseXML", "");jsonBody.put("IsOfflineBooking", "false");
    ...
    public class MyAppAdapter extends BaseAdapter implements DatePickerDialog.OnDateSetListener{
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (rowView == null) {
                ...
                viewHolder.txtTitle = (TextView) rowView.findViewById(R.id.AdultsCount);
            ...
            rowView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ImageView close= (ImageView) dialog.findViewById(R.id.closePopup);
