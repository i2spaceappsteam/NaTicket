...
import com.NaTicket.n.flights.adpaters.Domestic_Return_Adapter;
...
public class Flights_Domestic_Return extends BackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbartitle.setText(selDetails.getTo_City_ID()+" -> "+selDetails.getFrom_City_ID());
        getLoginPreferences();
    ...
    private void callFlightsData() {
        if (Util.isNetworkAvailable(getApplicationContext())) {
               setFlightsData(flights_main_dto.getDomesticReturnFlights());
        } else {
    ...
    private void setFlightsData(ArrayList<DomesticReturnFlightDTO> availableFlights) {
        domestic_return_adapter = new Domestic_Return_Adapter(this, availableFlights);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getApplicationContext());
        flights_View.setLayoutManager(mLayoutManager);
        flights_View.setItemAnimator(new DefaultItemAnimator());
        flights_View.setAdapter(domestic_return_adapter);
    }
    ...
    private void sortfilter(){
        sort.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                BottomSheetDialog dialog=new BottomSheetDialog(Flights_Domestic_Return.this);
                ...
                hotels.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (hotels.getTag().toString().equals("Asc")){
                            hotels.setTag("Desc");
                            Tags="TitleASC";
                            ArrayList<DomesticReturnFlightDTO> H=domestic_return_adapter.sortByNameAsc();
                            domestic_return_adapter.refreshList(H);
                            hotels.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.arrow_down, 0);
                        }else {
                            hotels.setTag("Asc");
                            Tags="TitleDSC";
                            ArrayList<DomesticReturnFlightDTO> h=domestic_return_adapter.sortByNameDesc();
                            domestic_return_adapter.refreshList(h);
                            hotels.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.arrow_up, 0);
                        }
                    }
                ...
                star_rating.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (star_rating.getTag().equals("Asc")){
                            ...
                            Tags="DURASC";
                            ArrayList<DomesticReturnFlightDTO> h=domestic_return_adapter.sortByTimeAsc();
                            domestic_return_adapter.refreshList(h);
                            star_rating.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.arrow_down,0);
                        }else{
                            star_rating.setTag("Asc");
                            Tags="DURDSC";
                            ArrayList<DomesticReturnFlightDTO> h=domestic_return_adapter.sortByTimeDesc();
                            domestic_return_adapter.refreshList(h);
                            star_rating.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.arrow_up,0);
                        }
                    }
                ...
                price.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (price.getTag().toString().equals("Asc")){
                            price.setTag("Desc");
                            Tags="FareASC";
                            ArrayList<DomesticReturnFlightDTO> h=domestic_return_adapter.sortByPriceAsc();
                            domestic_return_adapter.refreshList(h);
                            price.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.arrow_down,0);
                        }else {
                            price.setTag("Asc");
                            Tags="FareDSC";
                            ArrayList<DomesticReturnFlightDTO> h=domestic_return_adapter.sortByPriceDesc();
                            domestic_return_adapter.refreshList(h);
                            price.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.arrow_up,0);
                        }
                    }
    ...
    public void FilterMethod(){
        ArrayList<DomesticReturnFlightDTO> available_flights=new ArrayList<>();
        available_flights=flights_main_dto.getDomesticReturnFlights();
        ArrayList<DomesticReturnFlightDTO> Filteredlist=new ArrayList<>();
                ...
                for (int k = 0; k < Selecteditems.size(); k++) {
                    ...
                    if (filter_details.getStops() != null && filter_details.getStops().size() != 0) {
                        if (filter_details.getStops().contains(0) && !filter_details.getStops().contains(1) && !filter_details.getStops().contains(2)) {
                            if (filter_details.getStops().contains(Flight_Utils.getLengthforfilters(available_flights.get(m).getFlightSegments().size()))) {
                                Isvalid = true;
                            } else {
                                Isvalid = false;
                                break;
                    ...
                    if (filter_details.getRule() != null && filter_details.getRule().size() != 0) {
                        if (filter_details.getRule().contains("Refundable") && !filter_details.getRule().contains("Non Refundable")) {
                            if (filter_details.getRule().contains(available_flights.get(m).getFlightSegments().get(0).getBookingClassFare().getRule())) {
                                Isvalid = true;
                            } else {
                                Isvalid = false;
                                break;
                    ...
                    try {
                        ...
                        String dept_time = Flight_Utils.getTime(available_flights.get(m).getFlightSegments().get(0).getDepartureDateTime());
    ...
    private void callTaxDetails(){
        ...
        if (Util.isNetworkAvailable(getApplicationContext())) {
            ServiceClasses.getTaxDetails(Flights_Domestic_Return.this,Constants.GetTaxDetails,prepayload());
        } else {
            Util.showMessage(this, Constants.NO_INT_MSG);
        }
    }
    ...
    public void postTaxDetailsResponse(String response) {
        ...
        if (response!=null){
            ...
            if (Util.getTaxResponseCode(response) == 14) {
                ...
                final double TotalFare = d + Servicecharge + Operatercharge + Markepcharge;
                SelReturnFlight.setFareDetails(fareDetailsDTO);
    ...
    private void send_to_nextactivity(){
        Intent ip = new Intent(Flights_Domestic_Return.this, Domestic_Flight_Review.class);
        ip.putExtra("selDetails",selDetails);
        ip.putExtra("SelOnwardFlight",SelOnwardFlight);
        ip.putExtra("SelReturnFlight",SelReturnFlight);
    ...
    private String prepayload() {
        ...
        try {
            for(int i=0;i<SelOnwardFlight.getFlightSegments().size();i++) {
                onward_array.put(new JSONObject(gson.toJson(SelOnwardFlight.getFlightSegments().get(i))));
            }

            for(int i=0;i<SelReturnFlight.getFlightSegments().size();i++) {
                return_array.put(new JSONObject(gson.toJson(SelReturnFlight.getFlightSegments().get(i))));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            bcparam.put("Provider", SelReturnFlight.getProvider());
            ...
            bcparam.put("ImagePath", SelOnwardFlight.getFlightSegments().get(0).getImageFileName());
            bcparam.put("ImagePathRet", SelReturnFlight.getFlightSegments().get(0).getImageFileName());
            bcparam.put("Rule", SelOnwardFlight.getFlightSegments().get(0).getBookingClassFare().getRule());
            bcparam.put("key", SelOnwardFlight.getOriginDestinationoptionId().getKey());
            bcparam.put("RuleRet", SelReturnFlight.getFlightSegments().get(0).getBookingClassFare().getRule());
            bcparam.put("keyRet", SelReturnFlight.getOriginDestinationoptionId().getKey());
            bcparam.put("FlightId", "");
            bcparam.put("FlightIdRet", "");
            bcparam.put("OnwardFlightSegments", onward_array);
            bcparam.put("ReturnFlightSegments", return_array);
            bcparam.put("FareDetails", new JSONObject(gson.toJson(SelReturnFlight.getFareDetails())));
            bcparam.put("BookingDate", "0001-01-01T00:00:00");
            bcparam.put("PromoCode", "");
            bcparam.put("PromoCodeAmount", "0");
            bcparam.put("PostMarkup", "");
            bcparam.put("OcTax", SelOnwardFlight.getFlightSegments().get(0).getOcTax());
            ...
            bcparam.put("ActualBaseFareRet", SelReturnFlight.getFareDetails().getChargeableFares().getActualBaseFare());
            bcparam.put("TaxRet", SelReturnFlight.getFareDetails().getChargeableFares().getTax());
            bcparam.put("STaxRet", SelReturnFlight.getFareDetails().getChargeableFares().getSTax());
            bcparam.put("SChargeRet", SelReturnFlight.getFareDetails().getChargeableFares().getSCharge());
            bcparam.put("TDiscountRet", SelReturnFlight.getFareDetails().getChargeableFares().getTDiscount());
            bcparam.put("TPartnerCommissionRet", SelReturnFlight.getFareDetails().getChargeableFares().getTPartnerCommission());
            bcparam.put("TSDiscountRet", SelReturnFlight.getFareDetails().getNonchargeableFares().getTSdiscount());
            bcparam.put("TChargeRet", SelReturnFlight.getFareDetails().getNonchargeableFares().getTCharge());
            bcparam.put("TMarkupRet", SelReturnFlight.getFareDetails().getNonchargeableFares().getTMarkup());
            ...
            bcparam.put("ReturnDate", selDetails.getReturn_date());
            ...
            if(SelReturnFlight.getFlightSegments().size()-1==0){
                bcparam.put("IsNonStopFlight", "false");
            }else{
                bcparam.put("IsNonStopFlight", "true");
            }
