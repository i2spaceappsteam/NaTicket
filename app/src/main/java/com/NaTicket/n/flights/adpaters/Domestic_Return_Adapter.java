...
public class Domestic_Return_Adapter extends RecyclerView.Adapter<Domestic_Return_Adapter.ViewHolder>{

    ArrayList<DomesticReturnFlightDTO> mFilteredList=new ArrayList<>();
    Flights_Domestic_Return activity;
    Currency_Utils currency_utils;
    private static final String TAG = "DomesticListAdapter";

    public Domestic_Return_Adapter(Flights_Domestic_Return flights_onward_activity, ArrayList<DomesticReturnFlightDTO> availableFlights) {
    ...
    @Override
    public Domestic_Return_Adapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.flights_dom_onward, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(Domestic_Return_Adapter.ViewHolder viewHolder, final int position) {
    ...
    public ArrayList<DomesticReturnFlightDTO> sortByNameAsc() {
        Comparator<DomesticReturnFlightDTO> comparator = new Comparator<DomesticReturnFlightDTO>() {
            @Override
            public int compare(DomesticReturnFlightDTO object1, DomesticReturnFlightDTO object2) {
    ...
    public ArrayList<DomesticReturnFlightDTO> sortByNameDesc() {
        Comparator<DomesticReturnFlightDTO> comparator = new Comparator<DomesticReturnFlightDTO>() {
            @Override
            public int compare(DomesticReturnFlightDTO object1, DomesticReturnFlightDTO object2) {
    ...
    public ArrayList<DomesticReturnFlightDTO> sortByTimeAsc() {
        Comparator<DomesticReturnFlightDTO> comparator = new Comparator<DomesticReturnFlightDTO>() {
            @Override
            public int compare(DomesticReturnFlightDTO object1, DomesticReturnFlightDTO object2) {
    ...
    public ArrayList<DomesticReturnFlightDTO> sortByTimeDesc() {
        Comparator<DomesticReturnFlightDTO> comparator = new Comparator<DomesticReturnFlightDTO>() {
            @Override
            public int compare(DomesticReturnFlightDTO object1, DomesticReturnFlightDTO object2) {
                String value1 = ""+Flight_Utils.getTime(object1.getFlightSegments().get(0).getDepartureDateTime());
    ...
    public ArrayList<DomesticReturnFlightDTO> sortByPriceAsc() {
        Comparator<DomesticReturnFlightDTO> comparator = new Comparator<DomesticReturnFlightDTO>() {
            @Override
            public int compare(DomesticReturnFlightDTO object1, DomesticReturnFlightDTO object2) {
    ...
    public ArrayList<DomesticReturnFlightDTO> sortByPriceDesc() {
        Comparator<DomesticReturnFlightDTO> comparator = new Comparator<DomesticReturnFlightDTO>() {
            @Override
            public int compare(DomesticReturnFlightDTO object1, DomesticReturnFlightDTO object2) {
                double Total1=object1.getFareDetails().getChargeableFares().getActualBaseFare()+object1.getFareDetails().getChargeableFares().getTax()+
    ...
    public void refreshList(ArrayList<DomesticReturnFlightDTO> list){
        if (list != null) {
            this.mFilteredList= list;
            for (DomesticReturnFlightDTO ho : mFilteredList) {
