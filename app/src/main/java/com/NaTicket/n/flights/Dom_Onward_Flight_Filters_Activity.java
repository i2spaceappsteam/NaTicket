...
public class Dom_Onward_Flight_Filters_Activity extends BackActivity implements View.OnClickListener{

    LinearLayout FareType_Layout,Airlines_Layout,Stops_Layout,Dept_layout,Arrival_layout;
    ArrayList<DomesticOnwardFlightDTO> dom_onward_list;
    ...
    private void SetAirlines_Layout(ArrayList<String> Airlines,LinearLayout Check_box_layout){
        if(Airlines.size()>0){
            ...
            for(int i=0;i<Airlines.size();i++){
                final CheckBox checkBox = new CheckBox(Dom_Onward_Flight_Filters_Activity.this);
                FontTypeface fontTypeface=new FontTypeface(Dom_Onward_Flight_Filters_Activity.this);
