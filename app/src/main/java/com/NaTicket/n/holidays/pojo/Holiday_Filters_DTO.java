...
public class Holiday_Filters_DTO implements Serializable {
    ...
    private ArrayList<String> Selected_Sub;
    ...
    public ArrayList<String> getSelected_Sub() {
        return Selected_Sub;
    }

    public void setSelected_Sub(ArrayList<String> filteredarray) {
        this.Selected_Sub =filteredarray ;
    }
