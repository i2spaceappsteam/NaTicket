...
import com.NaTicket.n.common.fragments.adapters.Adapter_Hotel_Reports;
...
public class Reports_Hotels extends Fragment{
    ...
    private void CallHotelReports() {
        if (Util.isNetworkAvailable(getActivity())) {
            showProgressDialog("Getting Hotel Reports",getActivity());
            Service_Reports.getHotelReports(Reports_Hotels.this,Constants.REPORTS,preparePayload());
        }else{
    ...
    public void postHotelsResponse(String response){
        ...
        if(response!=null) {
            ...
            Hotel_Tickets_pojo[] hotel_reports=gson.fromJson(reader, Hotel_Tickets_pojo[].class);
            if (hotel_reports!=null){
                no_recordFound.setVisibility(View.GONE);
                recyclerView.setVisibility(View.VISIBLE);
                Adapter_Hotel_Reports mAdapter = new Adapter_Hotel_Reports(getActivity(),hotel_reports);
