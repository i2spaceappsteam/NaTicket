...
//            });
    ...
    private void CallLoginScreen() {
        ...
        private void addBottomDots(int currentPage) {
            ...
            int[] colorsActive = getResources().getIntArray(R.array.slider_array_dot_active);
            int[] colorsInactive = getResources().getIntArray(R.array.slider_array_dot_inactive);
