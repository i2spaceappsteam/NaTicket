...
public class ReviewActivity extends BackActivity implements View.OnClickListener {
    ...
    private void init() {
        TextView addDetails = findViewById(R.id.addDetails);
        ...
        TextView checkoutTv = findViewById(R.id.checkoutTv);
        ...
        ConvinenceLayout = findViewById(R.id.conviinence_layout);
        checkboxAgree = findViewById(R.id.checkboxAgree);
        ExtraGuest = findViewById(R.id.extracharges);
...
*/
    ...
    public void showBottomSheet(ArrayList<String> content, String Title, final TextView value_toset) {
        ...
        final ArrayAdapter<String> cityAdapter = new ArrayAdapter<String>(ReviewActivity.this, R.layout.spinner_item, content);
